                   ...
                   <div class="col-lg-12 m-b-3">
                       <div class="box box-info" style="padding: 10px;">
                           <div class="box-header with-border p-t-1">
                             <a href="{{ url('dashboard/news/create') }}"> <button type="button" class="btn btn-primary mt-2 mb-2">Create News</button> </a>     
                           </div>
                           <div class="col-lg-12">
                               ...
                               <div class="table-responsive">
                                   <table class="table no-margin">
                                      <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='{{ url('/dashboard/news/edit/' . $product->id) }}'><span class="label label-success">Edit</span></a>
                                                </td>
                                                <td>
                                                     <form method="POST" action="{{ route('news.destroy', $product->id) }}">
                                                     @csrf
                                    ...
                                    <div class="pagination-container" style="margin-top:20px;">
                                         {{ $news->appends(request()->except('page'))->links('vendor.pagination.bootstrap-4') }}
                                    </div>
                               </div>
                               <!-- /.table-responsive -->
                           </div>
