<div class="wrapper boxed-wrapper">
    <header class="main-header">
        ...
        <a href="#" class="logo blue-bg">
            ...
            <span class="logo-mini"><img src="{{asset('dist/img/logo-n-blue.png')}}" alt=""  height="55"/></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img src="{{asset('dist/img/logo-n-blue.png')}}" alt="" height="55" /></span>
        </a>
        <!-- Header Navbar -->
                    ...
                    <li class="dropdown user user-menu p-ph-res">
                        ...
                        <ul class="dropdown-menu">
                            <li class="user-header">
                                ...
                                <p class="text-left">
                                    Abhishek Thapa <small style="font-size: 8px;">abhishekthapa115@gmail.com</small>
                                </p>
                            </li>
                            <li>
